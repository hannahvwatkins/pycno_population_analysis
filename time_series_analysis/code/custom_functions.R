...
abund_tranfs_ow<- function(probs){
  sum<- probs[1]*0+probs[2]*1+probs[3]*11+probs[4]*26+probs[5]*51+probs[6]*101+probs[7]*1001
  return(sum)
}
...
#plogis(x-c) 
#I double checked because I was confused
...
#this function does a basic posterior predictive check - had to create it 
#manually since none of the available ones work with an rstan object
